...
public class xDemographicGridmap extends PApplet{
...
//		}
		...
		records=new ArrayList<xDemographicGridmap.Record>();

		HashMap<String, Record> location2Records=new HashMap<String, xDemographicGridmap.Record>();
